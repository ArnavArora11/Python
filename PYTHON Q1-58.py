# ==========================================================
# Python Practice Programs (Q1 - Q58)
...
#Q54 write python code to demonstrate string function
print("\nQ54:")
text= 'hello, world!'
#changing case
lower = text.lower()
...
#trimming whitespace
stripped = text.strip()
leftstripped = text.lstrip()
rightstripped = text.rstrip()
...
print(lower,upper,title,stripped,leftstripped,rightstripped,words,joined,replaced,index,count)
print("This program is executed by Arnav Arora (0231BCA192)
...
#Q56 write python code to calculate the factorial of the given number using function
print("\nQ56:")
def factorial(n):
    if n < 0:
...
#Q57 Write a python program to  reverse a string without using predefined function
print("\nQ57:")
...
#Q58 write a python code to print armstrong number in a given range 
print("\nQ57:")
